...
function navigateToLivingRoom() {
    ...
    if (typeof createTornPaperTransition === 'function') {
        createTornPaperTransition('./living room-/living_room.html');
    } else {
        // Fallback to direct navigation
        window.location.href = './living room-/living_room.html';
    }
}
...
function navigateToDiningRoom() {
    // Use torn paper transition to navigate
    if (typeof createTornPaperTransition === 'function') {
        createTornPaperTransition('./dining hall-/index.html');
    } else {
        // Fallback to direct navigation
        window.location.href = './dining hall-/index.html';
    }
}
...
function navigateToOffice() {
    // Use torn paper transition to navigate
    if (typeof createTornPaperTransition === 'function') {
        createTornPaperTransition('./office-/index.html');
    } else {
        // Fallback to direct navigation
...
function navigateToBedroom() {
    // Use torn paper transition to navigate
    if (typeof createTornPaperTransition === 'function') {
        createTornPaperTransition('./bed room-/index.html');
    } else {
        // Fallback to direct navigation
        window.location.href = './bed room-/index.html';
    }
}
